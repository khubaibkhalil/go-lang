...
const (
	Printer_PrintString_FullMethodName = "/printer.Printer/PrintString"
)
...
type PrinterClient interface {
	PrintString(ctx context.Context, in *Print, opts ...grpc.CallOption) (*Print, error)
}
...
func (c *printerClient) PrintString(ctx context.Context, in *Print, opts ...grpc.CallOption) (*Print, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Print)
	err := c.cc.Invoke(ctx, Printer_PrintString_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PrinterServer interface {
	PrintString(context.Context, *Print) (*Print, error)
...
func (UnimplementedPrinterServer) PrintString(context.Context, *Print) (*Print, error) {
	return nil, status.Error(codes.Unimplemented, "method PrintString not implemented")
}
...
func RegisterPrinterServer(s grpc.ServiceRegistrar, srv PrinterServer) {
	// If the following call panics, it indicates UnimplementedPrinterServer was
...
func _Printer_PrintString_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Print)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PrinterServer).PrintString(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Printer_PrintString_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PrinterServer).PrintString(ctx, req.(*Print))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Printer_PrintString_Handler,
		},
	},
