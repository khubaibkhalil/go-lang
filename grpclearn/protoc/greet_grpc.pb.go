...
const (
	Example_SayHello_FullMethodName = "/greet.Example/SayHello"
)
...
func (c *exampleClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
...
func (UnimplementedExampleServer) SayHello(context.Context, *HelloRequest) (*HelloResponse, error) {
